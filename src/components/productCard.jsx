...
export default function ProductCard({
    ...
    className='flex flex-col flex-none hover:shadow-white/20 hover:shadow-2xl hover:opacity-75 overflow-hidden rounded-md bg-white/50 bg-blend-overlay m-2 h-fit touch:m-[0px] touch:w-40 '+className;
